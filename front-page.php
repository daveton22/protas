...
<section class="hero" id="beranda">
  ...
  <div class="hero-bg-glow" id="her   oGl ow"></div>
          ...
          <div class="phone-group" id="phoneGroup">
            ...
            <div class="phone-3d phone-main">
              <div class="phone-inner">
                <img src="<?php echo esc_url( $theme_uri ); ?>/assets/images/dashboard-mahasiswa.png"
            ...
            <div class="phone-3d phone-left">
              <div class="phone-inner">
                <img src="<?php echo esc_url( $theme_uri ); ?>/assets/images/profile-dosen.png"
            ...
            <div class="phone-3d phone-right">
              <div class="phone-inner">
                <img src="<?php echo esc_url( $theme_uri ); ?>/assets/images/bimbingan.png"
            ...
            <div class="phone-3d phone-bl">
              <div class="phone-inner">
                <img src="<?php echo esc_url( $theme_uri ); ?>/assets/images/dashboard-dosen.png"
            ...
            <div class="phone-3d phone-br">
              <div class="phone-inner">
                <img src="<?php echo esc_url( $theme_uri ); ?>/assets/images/profile-mahasiswa.png"
...
<footer class="footer">
  <div class="footer-inner">
    <div class="footer-top">
      ...
      <div class="footer-col"><h4>Platform</h4><ul><li><a href="#fitur">Fitur</a></li><li><a href="#cara-kerja">Cara Kerja</a></li><li><a href="#pengguna">Untuk Pengguna</a></li><li><a href="#progres">Progres</a></li></ul></div>
      ...
      <div class="footer-col"><h4>Lainnya</h4><ul><li><a href="#faq">FAQ</a></li><li><a href="#">Kebijakan Privasi</a></li><li><a href="#">Syarat &amp; Ketentuan</a></li><li><a href="#">Hubungi Kami</a></li></ul></div>
    </div>
